...
proj01=Projeto(titulo='Proj1', data_inicio='2015-02-10', data_termino='',
               justificativa='Projeto de pesquisa', metodologia='pesquisa', resultados_esperados='conclusão da pesquisa')

proj02=Projeto(titulo='Proj1', data_inicio='2015-01-21', data_termino='',
...
# Criando membros
membro01 = Membro(nome='Juliana', cpf='1234567891011',data_nascimento='1995-01-01',
                   email='juliana@email.com', telefone='9999-9990', matricula='20142148060154')

membro02 = Membro(nome='Luan', cpf='1234567891012',data_nascimento='1993-01-01',
